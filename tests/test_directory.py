from coe_number import directory
...
class DirectoryTest(unittest.TestCase):
    ...
    @mock.patch("coe_number.directory.check_directory", return_value=True)
    ...
    @mock.patch("pathlib.Path")
    @mock.patch("coe_number.directory.check_directory", return_value=False)
    ...
    def test_check_directory_with_test_should_false(self):
        path = mock.MagicMock()
    ...
    @mock.patch("pathlib.Path")
    def test_create_directory_with_default_parameter(self, path_mock):
        directory.create_directory()
        path_mock.assert_called_with(1)
